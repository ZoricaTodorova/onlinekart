...
// 			exit();
			...
			$pdf->Cell(-15);
			$pdf->Cell(20,5,'Напомени',0,1,'L');
			$pdf->SetFont('Arial','',7);
			$pdf->SetTextColor(0,0,0);
			$pdf->Cell(-15);
			$pdf->Cell(0,5,'Ве молиме најдоцна до наведениот датум за плаќање да го подмирите Вашиот долг. За секое задоцнување',0,1,'L');
			$pdf->Cell(-15);
			$pdf->Cell(0,5,'Ви се пресметува законска казнена камата.',0,1,'L');
			$pdf->Cell(-15);
