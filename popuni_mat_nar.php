...
$sql = "SELECT concat(cod,' - ',opis) as celo, IFNULL((select text from grupi_mat where grupa=materijali.grupa ), '') as grupa_opis from materijali
 		where godina ='2014' and tip in ('F','R') and (cod LIKE '%".$q."%' or opis LIKE '%".$q1251."%' or opis_a like '%".$q."%')";
