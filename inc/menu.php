<?php function genmenu()
		...
		function genmenu14()
		{echo '<div class="menudiv"> 		<a class="menulink" href="index.php">Почетна</a> 		<a class="menulink" href="izbor_naracki.php">Нарачки</a> 		<a class="menulink" href="optprof.php">Промена на лозинка</a> 		<a class="menulink" href="help.php">Помош</a><span><span style="display:inline-block; position:absolute; right:70px">'.trim(getuser()).trim(ime_prezime_mt()).'</span><a class="menulink" href="logout.php" style="position:absolute;right:15px">Одјава</a></span></div>';
		}
		function genmenu2()
